...
if (mysqli_connect_errno()) {
    ...
    $insEvent_sql = "INSERT INTO Books (Category, Title, sStatus, YearContracted, AcademicYear, ResearchType, Refereed, sDescription, FacultyID)
	...
	if ($res === TRUE) {
	   ...
	   header("Refresh:1; url=../Lists/i_books.php");
	} else {
